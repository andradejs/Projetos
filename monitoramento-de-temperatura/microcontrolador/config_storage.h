...
struct ConfigurationData {
  ...
  unsigned int mqttPort;    /**< Porta de serviço do broker MQTT*/

  String wifiPass;          /**< Senha da rede Wi-Fi */
  String wifiSSID;          /**< SSID (nome) da rede Wi-Fi */

  float temperatureMax;     /**< Temperatura máxima permitida (°C) */
  float temperatureMin;     /**< Temperatura mínima permitida (°C) */
  float humidityMax;        /**< Umidade máxima permitida (%) */
